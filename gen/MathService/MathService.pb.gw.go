...
/*
Package MathService is a reverse proxy.
...
func RegisterMathServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server MathServiceServer) error {
	mux.Handle(http.MethodPost, pattern_MathService_Add_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/Maths.MathService/Add", runtime.WithHTTPPathPattern("/math/add"))
		if err != nil {
...
// "MathServiceClient" to call the correct interceptors. This client ignores the HTTP middlewares.
func RegisterMathServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client MathServiceClient) error {
	mux.Handle(http.MethodPost, pattern_MathService_Add_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/Maths.MathService/Add", runtime.WithHTTPPathPattern("/math/add"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_MathService_Add_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"math", "add"}, ""))
)
